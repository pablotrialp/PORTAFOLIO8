...
var imagenCambia = document.getElementById('imagenCambia')
...
function testing() {
    ...
    if (bien_ubicada == 9) {
        ...
        imagenCambia.style.display = "block";
        entorno.style.display = "none";

        /*bodi.style.background = "url(./img/pika.jpg)";
        bodi.style.backgroundSize = "cover";
        entorno.style.display = "none";
        portafolio.style.display = "block";
        portafolio.style.position = "absolute";*/
